                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <jet-nav-link style="margin-left: 50px; margin-right: 50px;"  :href="route('Next')" :active="route().current('Next')">
                                Next
                            </jet-nav-link>
                            <jet-nav-link style="margin-left: 50px; margin-right: 50px;"  :href="route('Design')" :active="route().current('Design')">
                                Design
                            </jet-nav-link>
                        </div>
